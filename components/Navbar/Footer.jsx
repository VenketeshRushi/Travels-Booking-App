          ...
          <div className="flex flex-col-reverse justify-evenly md:justify-between lg:flex-row">
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
              ...
              <div>
                ...
                <ul className="text-gray-600 dark:text-gray-400 font-medium">
                  <li className="mb-1">
                    <p className="hover:underline ">Train Tickets</p>
                  </li>
                  <li className="mb-1">
                    <p className="hover:underline">Bus Hire</p>
                  </li>
                  <li className="mb-1">
                    <p className="hover:underline">Cab Booking</p>
                  </li>
                  <li className="mb-1">
                    <p className="hover:underline">Tempo Traveller</p>
                  </li>
                </ul>
              </div>
              <div>
            ...
            <div className="w-full lg:w-1/3 flex items-start flex-col mb-6">
              ...
              <div className=" text-gray-400">
                <p>
                  ...
                  trusted by over 25 million happy customers globally. redBus
