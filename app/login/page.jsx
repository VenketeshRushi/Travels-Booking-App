          ...
          <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-10 lg:mt-3 xl:px-4 xl:max-w-2xl">
            ...
            <div className="mt-12">
              <form>
                ...
                <div className="mt-10">
                  <button className="bg-red-600 inline-block p-3 font-bold text-md uppercase leading-tight text-white shadow-md transition duration-150 ease-linear hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg tracking-wide w-full rounded-full">
                    Login
                  </button>
                </div>
              </form>
